...
<div class="sidebar">
    ...
    <div class="content">
        ...
        <div class="isi">
        <form action="<?= site_url('dashboard/updateDoctor') ?>" method="post">
        <?= csrf_field() ?>
        <input type="hidden" name="id_dokter" value="<?= $doctor['id_dokter'] ?>">
        <label for="nama_dokter">Nama Dokter:</label>
        <input type="text" name="nama_dokter" id="nama_dokter" value="<?= $doctor['nama_dokter'] ?>" required>
        <button type="submit">Update</button>
        <br>
        <a href="<?= site_url('dashboard/doctors') ?>" class="back-link">Kembali ke Data Dokter</a>
</div>
    </form>
    </div>
    <script>
