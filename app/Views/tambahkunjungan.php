...
<div class="sidebar">
    ...
    <div class="content">
        ...
        <div class="isi">
        <form action="<?= site_url('dashboard/visits/create') ?>" method="post">
                <?= csrf_field() ?>
                <div>
                    <label for="tgl_berobat">Tanggal Berobat:</label>
                    <input type="date" name="tgl_berobat" id="tgl_berobat" required>
                </div>
                <div>
                ...
                <div>
                    ...
                    <select class="o" name="id_dokter" id="id_dokter" required>
                        ...
                        <?php foreach ($doctors as $doctor): ?>
                            <option value="<?= $doctor['id_dokter'] ?>"><?= $doctor['nama_dokter'] ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
